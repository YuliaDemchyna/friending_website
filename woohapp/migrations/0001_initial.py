# Generated by Django 3.2.23 on 2024-01-01 07:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invite_code_used', models.CharField(blank=True, max_length=10, null=True)),
                ('unique_invite_code', models.CharField(max_length=6, unique=True)),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.Group', verbose_name='groups')),
                ('languages', models.ManyToManyField(to='woohapp.Language')),
